...
export const SideBar = ({data}) => {
    ...
    return (
        <div className='bg-zinc-800 p-4 rounded flex flex-col items-center justify-between lg:h-[100%] h-auto'>
            ...
            <button 
                className='bg-zinc-800 w-3/6 lg:w-full mt-4 lg:mt-0 text-white font-semibold flex items-center justify-center py-2 rounded hover:bg-white hover:text-zinc-900 transition-all duration-300'
                onClick={() => {
